...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private') {
    Swal.fire({
      ...
      text: 'This project\'s source code is private and not publicly available.',
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const found = projectData.find((p) => String(p.id) === id);
    if (found) {
      setProject({
        ...found,
        Img: found.Img || '/project-placeholder.jpg',
        Features: found.Features || [],
        TechStack: found.TechStack || [],
        Github: found.Github || 'https://github.com/PrabhashSwarnajith',
      });
    }
  }, [id]);
    ...
    <div className="min-h-screen bg-[#030014] px-[2%] sm:px-0 relative overflow-hidden">
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fade-in-up">
            <button
              onClick={() => navigate(-1)}
            ...
            <div className="space-y-6 md:space-y-10 animate-fade-in-up">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-gray-400 opacity-50">No technologies listed.</p>
                )}
              </div>
            </div>

            <div className="space-y-6 md:space-y-10 animate-scale-in">
